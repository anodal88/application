    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                @if(Auth::guest())
                    <a class="navbar-brand" data-toggle="modal" href="{{url('login')}}">
                        <i class="fa fa-sign-in"></i> Log In
                    </a>
                @else
                    <a class="navbar-brand" href="{{ url('/logout') }}"
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        {{Auth::user()->name}} | <i class="fa fa-sign-out"></i> Logout
                    </a>
                @endif
            ...
            <div class="row features-block">
                <div class="col-lg-3 features-text wow fadeInLeft">
                    ...
                    <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully
                        ...
                        query.
                        It has a huge collection of reusable UI components and integrated with latest jQuery
                        plugins.</p>
                    <a href="" class="btn btn-primary">Learn more</a>
                </div>
                ...
                <div class="col-lg-4 wow zoomIn">
                    <ul class="pricing-plan list-unstyled">
                        ...
                        <li class="pricing-desc">
                            Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam
                            an
                            soluta sensibus.
                        </li>
...
<footer>
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg">
            <p><strong>&copy; {{date("Y")}} Company Name</strong><br/> consectetur adipisicing elit. Aut eaque,
                laboriosam
